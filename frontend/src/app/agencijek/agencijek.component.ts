...
@Component({
  selector: 'app-agencijek',
  templateUrl: './agencijek.component.html',
  styleUrls: ['./agencijek.component.css']
})
export class AgencijekComponent implements OnInit {
